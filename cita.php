...
<head>
  ...
  <title>VETERINARIA RESERVA</title>
...
<body class="sub_page">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <!--<li class="nav-item active">
                <a class="nav-link" href="about.html">Especialidades<span class="sr-only">(current)</span></a>
              </li>-->
              <!--<li class="nav-item">
                <a class="nav-link" href="departments.html">Servicios</a>
              </li>-->
              <!--<li class="nav-item">
  ...
  <!-- Sección Acerca de -->
  <section class="about_section " style="margin-top: 60px; margin-bottom: 30px;">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <!--<p>
                Estimado paciente llegar puntual a tu cita, de ser posible 20 minutos antes de su turno, de lo contrario pasará al sistema Orden de llegada, sin reclamo alguno
                Por políticas de Salud Primavera, no se atienden a menores de edad en la especialidad de Ginecóloga.
            </p>-->
            <a href="#" onclick="abrirModal()">Reserva</a> 
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- REVISA TUS CITAS SEPARADAS -->
  <div class="container theme-showcase">
    <h1 style="font-size: 20px;">Revisa tus citas programadas</h1>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter" id="modalTriggerBtn" style="display: none;">
  Launch demo modal
</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Registrar Cita Médica</h5>
      ...
      <div class="modal-body">
        ...
        <div id="mensajeRegistro" style="display: none;" class="alert alert-success" role="alert">
...
<script>
  function mostrarMensaje() {
    ...
    }, 3000); // El mensaje se oculta después de 3 segundos (3000 milisegundos)
  }
  ...
  function mostrarDoctores(especialidad) {
    ...
    if (especialidad === "Spa") {
      ...
      doctoresSelect.innerHTML = `
        ...
        <option value="drJuanPérez">Dr. Juan Pérez</option>
      `;
    } else {
      // Ocultar el select de doctores si no se elige una especialidad
      doctoresContainer.style.display = "none";
    }
  }
</script>
